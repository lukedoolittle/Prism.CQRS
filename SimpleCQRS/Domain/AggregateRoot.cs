...
namespace SimpleCQRS.Domain
{
    public abstract class AggregateRoot
    {
        ...
        protected readonly List<EventAction> _changes;
        ...
        public IEnumerable<EventAction> GetUncommittedChanges()
        {
            return _changes;
        }
        ...
        protected void ApplyChange<TEvent, TPayload>(Event domainEvent)
            where TEvent : PubSubEvent<TPayload>, new()
        {
            domainEvent.AggregateId = Id;
            domainEvent.Version = ++EventVersion;
            Apply(domainEvent.GetType(), domainEvent);
            _changes.Add(new EventAction<TEvent, TPayload>(domainEvent));
        }
